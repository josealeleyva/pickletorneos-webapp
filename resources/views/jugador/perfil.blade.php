...
<div class="max-w-2xl mx-auto space-y-4">
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <div class="bg-gradient-to-r from-indigo-500 to-purple-600 px-4 py-6">
            <div class="flex flex-col items-center gap-3">
                ...
                <form action="{{ route('jugador.perfil.foto') }}" method="POST"
                    ...
                    <div class="relative">
                        ...
                        <label for="foto-input"
                               class="absolute bottom-0 right-0 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-md cursor-pointer hover:bg-indigo-50 transition"
                               title="Cambiar foto">
                ...
                <div class="text-center">
                    ...
                    <p class="text-indigo-100 text-sm mt-0.5">{{ auth()->user()->email }}</p>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4 sm:p-6">
        ...
        <form action="{{ route('jugador.perfil.update') }}" method="POST">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name"
                           ...
                           required
                           class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent {{ $errors->perfil->has('name') ? 'border-red-500' : 'border-gray-300' }}">
                ...
                <div>
                    ...
                    <input type="text" id="apellido" name="apellido"
                           ...
                           required
                           class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent {{ $errors->perfil->has('apellido') ? 'border-red-500' : 'border-gray-300' }}">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email"
                           ...
                           required
                           class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent {{ $errors->perfil->has('email') ? 'border-red-500' : 'border-gray-300' }}">
                ...
                <div>
                    ...
                    <input type="text" id="telefono" name="telefono"
                           ...
                           class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent {{ $errors->perfil->has('telefono') ? 'border-red-500' : 'border-gray-300' }}">
                ...
                <div>
                    ...
                    <input type="text" id="dni" name="dni"
                           ...
                           class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent {{ $errors->perfil->has('dni') ? 'border-red-500' : 'border-gray-300' }}">
                ...
                <div>
                    ...
                    <input type="text" id="fecha_nacimiento" name="fecha_nacimiento"
                           ...
                           maxlength="10"
                           autocomplete="off"
                           class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent {{ $errors->perfil->has('fecha_nacimiento') ? 'border-red-500' : 'border-gray-300' }}">
                ...
                <div>
                    ...
                    <select id="genero" name="genero"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white">
            ...
            <div class="pt-4 border-t border-gray-100">
                <button type="submit"
                        class="w-full sm:w-auto px-6 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-sm transition text-sm">
                    Guardar cambios
                </button>
            </div>
        </form>
                ...
                <div class="space-y-4 mb-4">
                    <div>
                        ...
                        <input type="password" id="current_password" name="current_password"
                               required
                               class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent {{ $errors->password->has('current_password') ? 'border-red-500' : 'border-gray-300' }}">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="password" id="password" name="password"
                                   ...
                                   class="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent {{ $errors->password->has('password') ? 'border-red-500' : 'border-gray-300' }}">
