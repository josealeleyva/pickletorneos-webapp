    ...
    <form action="{{ route('torneos.equipos.store', $torneo) }}" method="POST" class="space-y-4 sm:space-y-6" id="formEquipo">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    @if($categoriaObj)
                        ...
                        <div class="flex items-center gap-3 p-3 bg-brand-50 border border-brand-200 rounded-lg">
                            <span class="inline-flex items-center px-3 py-1 rounded-full bg-brand-600 text-white text-sm font-semibold">
                                {{ $categoriaObj->nombre }}
                            </span>
                            <a href="{{ route('torneos.equipos.index', $torneo) }}" class="text-xs text-brand-500 hover:text-brand-700 underline">
                                Cambiar categoría
                            </a>
                        </div>
                    @else
                        ...
                        <select id="categoria_id" name="categoria_id" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 @error('categoria_id') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 @error('nombre') border-red-500 @enderror"
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6">
            ...
            <div>
                ...
                <p id="avisoInscriptos" class="mt-1 text-xs text-accent-600 hidden">
        ...
        <div class="flex flex-wrap gap-3">
            <button type="submit" class="inline-flex items-center px-6 py-2.5 bg-brand-600 hover:bg-brand-700 text-white font-semibold rounded-lg shadow-md transition">
    ...
    <div class="bg-white rounded-lg max-w-md w-full p-6">
        ...
        <form id="formCrearJugador" onsubmit="crearJugador(event)" class="space-y-4">
            <div>
                ...
                <input type="text" id="jugador_nombre" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500">
            </div>
            <div>
                <label for="jugador_apellido" class="block text-sm font-medium text-gray-700 mb-1">Apellido</label>
                <input type="text" id="jugador_apellido" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500">
            </div>
            <div>
                <label for="jugador_dni" class="block text-sm font-medium text-gray-700 mb-1">DNI (opcional)</label>
                <input type="text" id="jugador_dni" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500">
            </div>
            <div>
                <label for="jugador_telefono" class="block text-sm font-medium text-gray-700 mb-1">Teléfono (opcional)</label>
                <input type="text" id="jugador_telefono" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500">
            </div>
            <div>
                <label for="jugador_email" class="block text-sm font-medium text-gray-700 mb-1">Email (opcional)</label>
                <input type="email" id="jugador_email" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500">
            ...
            <div>
                ...
                <input type="text" id="jugador_ranking" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500" placeholder="Ej: 1234, 3.5, A+">
            </div>

            <div class="flex gap-3 pt-2">
                <button type="submit" class="flex-1 px-4 py-2 bg-brand-600 hover:bg-brand-700 text-white font-medium rounded-lg transition">
                    Crear y Agregar
                </button>
