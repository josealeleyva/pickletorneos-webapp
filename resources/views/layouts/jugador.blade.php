...
<head>
    ...
    <title>@yield('title', 'Mi Panel') - Punto de Oro</title>
        ...
        <header class="lg:hidden bg-indigo-900 text-white sticky top-0 z-50">
            <div class="flex items-center justify-between px-4 py-3">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-indigo-300 text-xs">Mi Panel</p>
                </div>
        ...
        <aside id="sidebar" class="fixed lg:static inset-y-0 left-0 z-40 lg:z-0 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out w-64 bg-indigo-900 text-white flex-shrink-0 lg:flex flex-col">
            <div class="relative flex flex-col h-full bg-indigo-900">
                ...
                <div class="hidden lg:block p-6">
                    ...
                    <p class="text-indigo-300 text-sm mt-1">Mi Panel</p>
                </div>
                ...
                <nav class="flex-1 overflow-y-auto mt-6 lg:mt-0">
                    ...
                    <a href="{{ route('jugador.dashboard') }}"
                        class="flex items-center px-6 py-3 {{ request()->routeIs('jugador.dashboard') ? 'bg-indigo-800 border-l-4 border-indigo-400' : 'hover:bg-indigo-800' }}">
                    ...
                    <!-- Mis Torneos -->
                    <div class="px-6 py-2 mt-4 text-xs font-semibold text-indigo-400 uppercase">
                        Mi Actividad
                    </div>
                    ...
                    <a href="{{ route('jugador.partidos') }}"
                        class="flex items-center px-6 py-3 {{ request()->routeIs('jugador.partidos*') ? 'bg-indigo-800 border-l-4 border-indigo-400' : 'hover:bg-indigo-800' }}">
                    ...
                    <a href="{{ route('jugador.perfil') }}"
                        class="flex items-center px-6 py-3 {{ request()->routeIs('jugador.perfil*') ? 'bg-indigo-800 border-l-4 border-indigo-400' : 'hover:bg-indigo-800' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6 border-t border-indigo-800">
                    <a href="{{ route('jugador.perfil') }}" class="flex items-center hover:bg-indigo-800 p-2 rounded-lg transition -mx-2">
                        ...
                        <div class="ml-3 flex-1 min-w-0">
                            ...
                            <p class="text-xs text-indigo-300 truncate">Jugador</p>
                        </div>
