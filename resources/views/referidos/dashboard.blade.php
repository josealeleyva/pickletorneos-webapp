...
@section('content')
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-brand-600 mt-2">{{ $stats['creditos_disponibles'] }}</p>
                </div>
    ...
    <!-- Código de Referido -->
    <div class="bg-gradient-to-r from-brand-600 to-brand-500 rounded-lg shadow-lg p-8 mb-8 text-white">
